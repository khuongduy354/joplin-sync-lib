...
import { setupDatabaseAndSynchronizer } from "../test-utils";
...
describe("Synchronizer.ppk", () => {
  ...
  //  NOTE: Sync API should not be use for initializing E2E, to enable it, use a different client to initialize.
  ...
  //     expect(clientLocalPPK1.privateKey.encryptionMethod).toBe(
  ...
  //     expect(clientLocalPPK1.privateKey.ciphertext).toBe(
  //       clientLocalPPK2.privateKey.ciphertext
  //     );
